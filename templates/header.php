...
<head>
  ...
  <style>
    ...
    .btn { padding: 0.75rem 1.5rem; border-radius: 0.375rem; font-weight: 600; cursor: pointer; }
    .btn-blue { background-color: #4299e1; color: white; } .btn-blue:hover { background-color: #3182ce; }
    .btn-red { background-color: #ef4444; color: white; } .btn-red:hover { background-color: #dc2626; }
    .btn-green { background-color: #48bb78; color: white; } .btn-green:hover { background-color: #38a169; }
    .btn-indigo { background-color: #667eea; color: white; } .btn-indigo:hover { background-color: #5a67d8; }
    ...
    <nav class="space-x-2">
      <?php if ($is_logged_in_user): ?>
        ...
        <?php if ($current_user_is_admin): ?>
          ...
          <a href="index.php?page=profit_loss_report" class="px-3 py-2 hover:bg-gray-700 rounded">P&L Report</a>
          <a href="index.php?page=master_data_management" class="px-3 py-2 hover:bg-gray-700 rounded">Master Data</a>
        <?php endif; ?>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    hideLoader(); // Hide if loaded normally
  });
